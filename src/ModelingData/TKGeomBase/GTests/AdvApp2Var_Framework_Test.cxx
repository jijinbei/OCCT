...
TEST(AdvApp2Var_FrameworkTest, NodeIndexMapping_UsesGridLayout)
{
  ...
  EXPECT_EQ(aFramework.FirstNode(GeomAbs_IsoType::GeomAbs_IsoU, 2, 1), 2);
  EXPECT_EQ(aFramework.LastNode(GeomAbs_IsoType::GeomAbs_IsoU, 2, 1), 5);

  EXPECT_EQ(aFramework.FirstNode(GeomAbs_IsoType::GeomAbs_IsoV, 2, 1), 4);
  EXPECT_EQ(aFramework.LastNode(GeomAbs_IsoType::GeomAbs_IsoV, 2, 1), 5);
}
...
TEST(AdvApp2Var_FrameworkTest, UpdateInU_InsertsCutIsoAndNodes)
{
  ...
  EXPECT_EQ(aCutIso.Type(), GeomAbs_IsoType::GeomAbs_IsoU);
  ...
  EXPECT_EQ(aFramework.FirstNode(GeomAbs_IsoType::GeomAbs_IsoU, 2, 1), 2);
  EXPECT_EQ(aFramework.LastNode(GeomAbs_IsoType::GeomAbs_IsoU, 2, 1), 6);
}
