...
public:
  ...
  void SetConvType(
    const GeomConvert_ConvType theConvType = GeomConvert_ConvType::GeomConvert_Simplest)
  {
    myConvType = theConvType;
  }

  void SetTarget(const GeomAbs_SurfaceType theSurfType = GeomAbs_SurfaceType::GeomAbs_Plane)
  {
