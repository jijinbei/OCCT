...
bool IGESDimen_ToolSection::OwnCorrect(const occ::handle<IGESDimen_Section>& ent) const
{
...
void IGESDimen_ToolSection::OwnCheck(const occ::handle<IGESDimen_Section>& ent,
