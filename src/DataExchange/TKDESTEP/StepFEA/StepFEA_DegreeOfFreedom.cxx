...
StepFEA_EnumeratedDegreeOfFreedom StepFEA_DegreeOfFreedom::EnumeratedDegreeOfFreedom() const
{
  occ::handle<StepFEA_DegreeOfFreedomMember> SelMem =
    occ::down_cast<StepFEA_DegreeOfFreedomMember>(Value());
  if (SelMem.IsNull())
    return StepFEA_EnumeratedDegreeOfFreedom::StepFEA_XTranslation;
  ...
  {
    case 1:
      val = StepFEA_EnumeratedDegreeOfFreedom::StepFEA_XTranslation;
      break;
      //  case 2 : val = StepElement_EnumeratedCurveElementFreedom::StepElement_YTranslation; break;
      //  case 3 : val = StepElement_EnumeratedCurveElementFreedom::StepElement_ZTranslation; break;
      //  case 4 : val = StepElement_EnumeratedCurveElementFreedom::StepElement_XRotation; break;
      //  case 5 : val = StepElement_EnumeratedCurveElementFreedom::StepElement_YRotation; break;
      //  case 6 : val = StepElement_EnumeratedCurveElementFreedom::StepElement_ZRotation; break;
      //  case 7 : val = StepElement_EnumeratedCurveElementFreedom::StepElement_Warp; break;
      //  case 8 : val = StepElement_EnumeratedCurveElementFreedom::StepElement_None; break;
    default:
      return StepFEA_EnumeratedDegreeOfFreedom::StepFEA_XTranslation;
      break;
  }
