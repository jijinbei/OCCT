...
void RWStepGeom_RWQuasiUniformSurfaceAndRationalBSplineSurface::ReadStep(
  ...
  const occ::handle<StepGeom_QuasiUniformSurfaceAndRationalBSplineSurface>& ent) const
{
...
void RWStepGeom_RWQuasiUniformSurfaceAndRationalBSplineSurface::Share(
  const occ::handle<StepGeom_QuasiUniformSurfaceAndRationalBSplineSurface>& ent,
