...
public:
  ...
  //! Return name format for exporting Nodes; RWMesh_NameFormat_InstanceOrProduct
  //! by default.
  ...
  //! Return name format for exporting Meshes; RWMesh_NameFormat_Product by
  //! default.
...
protected:
  ...
  //! Write
  //! RWGltf_GltfRootElement_ExtensionsUsed/RWGltf_GltfRootElement_ExtensionsRequired
  //! sections (reserved).
