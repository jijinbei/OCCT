...
public:
  ...
  //! Add bufferView's into RWGltf_GltfRootElement::RWGltf_GltfRootElement_BufferViews section with
  //! images collected by AddImagesToGlb().
  Standard_EXPORT void FlushGlbBufferViews(RWGltf_GltfOStreamWriter* theWriter,
                                           const int                 theBinDataBufferId,
                                           int&                      theBuffViewId);

  //! Write RWGltf_GltfRootElement::RWGltf_GltfRootElement_Images section with images collected by
  //! AddImagesToGlb().
