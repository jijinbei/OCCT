...
enum class RWGltf_GltfArrayType
{
...
inline RWGltf_GltfArrayType RWGltf_GltfParseAttribType(const char* theType)
{
  ...
  {
    return RWGltf_GltfArrayType::RWGltf_GltfArrayType_TCoord1;
  }
  else if (IsEqual("JOINT", theType))
  {
    return RWGltf_GltfArrayType::RWGltf_GltfArrayType_Joint;
  }
  else if (IsEqual("WEIGHT", theType))
  {
    return RWGltf_GltfArrayType::RWGltf_GltfArrayType_Weight;
  }
