...
Prs3d_DimensionAspect::Prs3d_DimensionAspect()
    : myLineAspect(new Prs3d_LineAspect(Quantity_NOC_LAWNGREEN, Aspect_TypeOfLine::Aspect_TOL_SOLID, 1.0)),
      ...
      myExtensionSize(6.0),
      myArrowTailSize(6.0),
      myArrowOrientation(Prs3d_DimensionArrowOrientation::Prs3d_DAO_Fit),
      myTextHPosition(Prs3d_DimensionTextHorizontalPosition::Prs3d_DTHP_Fit),
      myTextVPosition(Prs3d_DimensionTextVerticalPosition::Prs3d_DTVP_Center),
