...
public:
  ...
  {
    return InquireLimit(Graphic3d_TypeOfLimit::Graphic3d_TypeOfLimit_MaxNbLights);
  }

  //! Request maximum number of active clipping planes supported by driver and hardware.
  int InquirePlaneLimit() const
  {
    return InquireLimit(Graphic3d_TypeOfLimit::Graphic3d_TypeOfLimit_MaxNbClipPlanes);
  }

  //! Request maximum number of views supported by driver.
  int InquireViewLimit() const
  {
    return InquireLimit(Graphic3d_TypeOfLimit::Graphic3d_TypeOfLimit_MaxNbViews);
  }
