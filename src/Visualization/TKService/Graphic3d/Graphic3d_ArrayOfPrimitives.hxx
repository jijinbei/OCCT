...
public: //! @name optional array of Indices/Edges for using shared Vertex data
  ...
  //! Convenience method, adds two vertex indices (a segment) in the range [1,VertexNumber()] in the
  //! array of segments (Graphic3d_TypeOfPrimitiveArray::Graphic3d_TOPA_SEGMENTS). Raises exception
  //! if array is not of type Graphic3d_TypeOfPrimitiveArray::Graphic3d_TOPA_SEGMENTS.
  //! @return the actual edges number
  int AddSegmentEdges(int theVertexIndex1, int theVertexIndex2)
  {
    Standard_TypeMismatch_Raise_if(myType
                                     != Graphic3d_TypeOfPrimitiveArray::Graphic3d_TOPA_SEGMENTS,
                                   "Not array of segments");
  ...
  //! the array of triangles. Raises exception if array is not of type
  ...
  //! Convenience method, adds four vertex indices (a quad) in the range [1,VertexNumber()] in the
  //! array of quads. Raises exception if array is not of type
  //! Graphic3d_TypeOfPrimitiveArray::Graphic3d_TOPA_QUADRANGLES.
  //! @return the actual edges number
  ...
  //! as two triangles. Raises exception if array is not of type
  //! Graphic3d_TypeOfPrimitiveArray::Graphic3d_TOPA_TRIANGLES.
  //! @return the actual edges number
  ...
  //! Raises exception if array is not of type
  //! Graphic3d_TypeOfPrimitiveArray::Graphic3d_TOPA_TRIANGLES.
