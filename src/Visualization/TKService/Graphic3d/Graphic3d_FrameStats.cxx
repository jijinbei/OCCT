  ...
  Graphic3d_RenderingParams::PerfCounters theFlags) const
{
  ...
  const bool hasImmediate =
    aStats[Graphic3d_FrameStatsCounter::Graphic3d_FrameStatsCounter_NbLayersImmediate] != 0
    || aStats.ImmediateFrameRate() > 0.0;
