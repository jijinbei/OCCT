...
MeshVS_Mesh::MeshVS_Mesh(const bool theIsAllowOverlapped)
{
  ...
  myCurrentDrawer->SetInteger(MeshVS_DA_InteriorStyle,
                              static_cast<int>(Aspect_InteriorStyle::Aspect_IS_SOLID));
  ...
  myCurrentDrawer->SetInteger(MeshVS_DA_EdgeType,
                              static_cast<int>(Aspect_TypeOfLine::Aspect_TOL_SOLID));
  myCurrentDrawer->SetInteger(MeshVS_DA_MarkerType,
                              static_cast<int>(Aspect_TypeOfMarker::Aspect_TOM_O));
  myCurrentDrawer->SetColor(MeshVS_DA_MarkerColor, Quantity_NOC_WHITE);
  myCurrentDrawer->SetDouble(MeshVS_DA_MarkerScale, 1.0);
  myCurrentDrawer->SetInteger(MeshVS_DA_BeamType,
                              static_cast<int>(Aspect_TypeOfLine::Aspect_TOL_SOLID));
  ...
  mySelectionDrawer->SetInteger(MeshVS_DA_MarkerType,
                                static_cast<int>(Aspect_TypeOfMarker::Aspect_TOM_STAR));
  ...
  mySelectionDrawer->SetInteger(MeshVS_DA_BeamType,
                                static_cast<int>(Aspect_TypeOfLine::Aspect_TOL_SOLID));
  ...
  myHilightDrawer->SetInteger(MeshVS_DA_InteriorStyle,
                              static_cast<int>(Aspect_InteriorStyle::Aspect_IS_SOLID));
  ...
  myHilightDrawer->SetInteger(MeshVS_DA_EdgeType,
                              static_cast<int>(Aspect_TypeOfLine::Aspect_TOL_SOLID));
  ...
  myHilightDrawer->SetInteger(MeshVS_DA_BeamType,
                              static_cast<int>(Aspect_TypeOfLine::Aspect_TOL_SOLID));
  myHilightDrawer->SetDouble(MeshVS_DA_BeamWidth, 3.0);

  myHilightDrawer->SetInteger(MeshVS_DA_MarkerType,
                              static_cast<int>(Aspect_TypeOfMarker::Aspect_TOM_STAR));
      ...
      case MeshVS_SMF_Mesh: {
        ...
        switch (mySelectionMethod)
        {
          ...
          case MeshVS_MeshSelectionMethod::MeshVS_MSM_NODES: {
            theSelection->Add(
              new MeshVS_CommonSensitiveEntity(myWholeMeshOwner,
                                               this,
                                               MeshVS_MeshSelectionMethod::MeshVS_MSM_NODES));
            break;
          }
          case MeshVS_MeshSelectionMethod::MeshVS_MSM_PRECISE: {
            theSelection->Add(
              new MeshVS_CommonSensitiveEntity(myWholeMeshOwner,
                                               this,
                                               MeshVS_MeshSelectionMethod::MeshVS_MSM_PRECISE));
