...
public:
  ...
  //! The default type is GeomAbs_JoinType::GeomAbs_Arc where the vertices generate
  //! sections of a circle.
  //! If join type is GeomAbs_JoinType::GeomAbs_Intersection, the edges that
  ...
  Standard_EXPORT void Init(const GeomAbs_JoinType Join         = GeomAbs_JoinType::GeomAbs_Arc,
                            const bool             IsOpenResult = false);
