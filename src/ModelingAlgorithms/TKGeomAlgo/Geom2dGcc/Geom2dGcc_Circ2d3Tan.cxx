      ...
      pararg3(1, 16)
{
  ...
  const occ::handle<Geom2d_Curve>& CC3   = C3.Curve();
  ...
  if ((Type1 == GeomAbs_CurveType::GeomAbs_Line || Type1 == GeomAbs_CurveType::GeomAbs_Circle)
      && (Type2 == GeomAbs_CurveType::GeomAbs_Line || Type2 == GeomAbs_CurveType::GeomAbs_Circle)
      && (Type3 == GeomAbs_CurveType::GeomAbs_Line || Type3 == GeomAbs_CurveType::GeomAbs_Circle))
  {
    if (Type1 == GeomAbs_CurveType::GeomAbs_Circle)
    {
      ...
      if (Type2 == GeomAbs_CurveType::GeomAbs_Circle)
      {
        ...
        if (Type3 == GeomAbs_CurveType::GeomAbs_Circle)
        {
          occ::handle<Geom2d_Circle> CCC3 = occ::down_cast<Geom2d_Circle>(CC3);
        ...
        {
          occ::handle<Geom2d_Line> LL3 = occ::down_cast<Geom2d_Line>(CC3);
...
Geom2dGcc_Circ2d3Tan::Geom2dGcc_Circ2d3Tan(const occ::handle<Geom2d_Point>& Point1,
                                           const occ::handle<Geom2d_Point>& Point2,
...
bool Geom2dGcc_Circ2d3Tan::IsDone() const
{
  return WellDone;
}
...
void Geom2dGcc_Circ2d3Tan::WhichQualifier(const int        Index,
...
void Geom2dGcc_Circ2d3Tan::Tangency1(const int Index,
                                     double&   ParSol,
                                     double&   ParArg,
...
void Geom2dGcc_Circ2d3Tan::Tangency2(const int Index,
                                     double&   ParSol,
                                     double&   ParArg,
                                     gp_Pnt2d& PntSol) const
{
...
void Geom2dGcc_Circ2d3Tan::Tangency3(const int Index,
                                     double&   ParSol,
                                     double&   ParArg,
                                     gp_Pnt2d& PntSol) const
{
...
bool Geom2dGcc_Circ2d3Tan::IsTheSame1(const int Index) const
{
  if (!WellDone)
  {
    throw StdFail_NotDone();
...
bool Geom2dGcc_Circ2d3Tan::IsTheSame2(const int Index) const
{
  if (!WellDone)
  {
    throw StdFail_NotDone();
...
bool Geom2dGcc_Circ2d3Tan::IsTheSame3(const int Index) const
{
  if (!WellDone)
  {
    throw StdFail_NotDone();
