...
//! -   ChFi3d_FilletShape::ChFi3d_Rational (default value), which is the
//! standard NURBS representation of circles,
//! -   ChFi3d_FilletShape::ChFi3d_QuasiAngular, which is a NURBS
//! representation of circles where the parameters
//! match those of the circle,
//! -   ChFi3d_FilletShape::ChFi3d_Polynomial, which corresponds to a
