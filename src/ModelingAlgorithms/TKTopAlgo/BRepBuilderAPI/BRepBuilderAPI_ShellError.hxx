...
//! -   BRepBuilderAPI_ShellError::BRepBuilderAPI_ShellDone No error occurred.
//! The shell is correctly built.
//! -   BRepBuilderAPI_ShellError::BRepBuilderAPI_EmptyShell No initialization of
//! the algorithm: only an empty constructor was used.
//! -   BRepBuilderAPI_ShellError::BRepBuilderAPI_DisconnectedShell not yet used
