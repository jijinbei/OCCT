...
//! -      BRepBuilderAPI_FaceError::BRepBuilderAPI_FaceDone No error occurred. The face is
//! correctly built.
//! -      BRepBuilderAPI_FaceError::BRepBuilderAPI_NoFace No initialization of the
//! algorithm; only an empty constructor was used.
//! -      BRepBuilderAPI_FaceError::BRepBuilderAPI_NotPlanar
