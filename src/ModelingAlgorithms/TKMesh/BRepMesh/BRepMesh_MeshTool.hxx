...
public:
                   ...
                   int (&theEdges)[3])
  {
    ...
    myStructure->AddElement(
      BRepMesh_Triangle(theEdges, aOri, BRepMesh_DegreeOfFreedom::BRepMesh_Free));
  }
  ...
  {
    const int aLinkIt = myStructure->AddLink(
      BRepMesh_Edge(theFirstNode, theLastNode, BRepMesh_DegreeOfFreedom::BRepMesh_Free));
